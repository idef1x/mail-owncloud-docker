...
sed -i "s/upload_max_filesize\ \=\ 2M/upload_max_filesize\ \=\ 1024M/g" /etc/php/7.0/apache2/php.ini
sed -i "s/post_max_size\ \=\ 8M/post_max_size\ \=\ 1048M/g" /etc/php/7.0/apache2/php.ini
...
sed -i "s/www\/owncloud/www\/html/g" /etc/apache2/conf-available/owncloud.conf
